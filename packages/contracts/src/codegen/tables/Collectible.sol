...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Collectible")));
bytes32 constant CollectibleTableId = _tableId;
...
library Collectible {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("Collectible", _fieldNames);
  }
